...
const INSTAGRAM_FILE_PATH = path.join(
  process.cwd(),
  "data",
...
export async function getFeaturedCurators() {
  try {
    ...
    return users.map((u: any) => ({
      ...
      imageUrl:
        u.avatarUrl ||
        `https://ui-avatars.com/api/?name=${u.fullName}&background=random`, // GridItem compatibility
...
const MOCK_CATEGORIES = [
  {
    ...
    slug: "kadin-giyim",
    image:
      "https://images.unsplash.com/photo-1523381294911-8d3cead1858b?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: "2",
    name: "Erkek Giyim",
  ...
  },
  {
    ...
    slug: "aksesuar",
    image:
      "https://images.unsplash.com/photo-1561053720-76ae6740c114?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: "5",
    name: "Çanta",
    ...
    slug: "canta",
    image:
      "https://images.unsplash.com/photo-1584917865442-de89df76cca8?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: "6",
    name: "Ev & Yaşam",
    ...
    slug: "ev-yasam",
    image:
      "https://images.unsplash.com/photo-1556912167-f57ade81469f?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: "7",
    name: "Kozmetik",
    ...
    slug: "kozmetik",
    image:
      "https://images.unsplash.com/photo-1580870069867-ce3551579710?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: "8",
    name: "Takı",
    ...
    slug: "taki",
    image:
      "https://images.unsplash.com/photo-1599643478518-a784f5de9c2f?q=80&w=800&auto=format&fit=crop",
  },
];
...
const MOCK_CIRCLES = [
  {
    id: "1",
    name: "Minimalist Şıklık",
    title: "Minimalist Şıklık",
    slug: "minimalist-siklik",
    image:
      "https://images.unsplash.com/photo-1512374382149-233c42b6a83b?q=80&w=800&auto=format&fit=crop",
  },
  {
    ...
    slug: "sokak-modasi",
    image:
      "https://images.unsplash.com/photo-1503341504253-b579171505a1?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: "3",
    name: "Vintage Tutkunları",
    title: "Vintage Tutkunları",
    slug: "vintage-tutkunlari",
    image:
      "https://images.unsplash.com/photo-1534452203293-494d7dddc114?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: "4",
    ...
    image:
      "https://images.unsplash.com/photo-1516253593-dd45bc759571?q=80&w=800&auto=format&fit=crop",
  },
];
  ...
  try {
    ...
    if (featuredIds.length > 0) {
      return allItems.filter(
        (item: any) =>
          featuredIds.includes(item.id) || featuredIds.includes(item.slug),
      );
    }
...
const MOCK_BRANDS = [
  ...
  },
  {
    ...
    slug: "network",
    image:
      "https://images.unsplash.com/photo-1492707892479-7bc8d5a4971a?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: "6",
    title: "YARGICI",
  ...
  },
  {
    ...
    slug: "divarese",
    image:
      "https://images.unsplash.com/photo-1511556820780-dba8c3c29c4b?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: "8",
    title: "DESA",
  ...
  try {
    ...
    if (dbCircle) {
      return {
        ...
        image:
          dbCircle.coverImageUrl ||
          `https://ui-avatars.com/api/?name=${dbCircle.name}&background=random`,
        slug: dbCircle.slug,
        ...
        curators: dbCircle.members.map((m: any) => ({
          ...
          image:
            m.user.avatarUrl ||
            `https://ui-avatars.com/api/?name=${m.user.username}&background=random`,
        })),
        isDbBacked: true,
      };
    }
  ...
  const products = Array(8)
    ...
    .map((_, i) => ({
      ...
      image:
        ...
        "https://images.unsplash.com/photo-1445205170230-053b83016050?q=80&w=800&auto=format&fit=crop",
      curator: {
        name: curators[i % curators.length].name,
        avatar: curators[i % curators.length].image,
      },
    }));
...
export async function addSection(userId: string, title: string) {
  try {
    ...
    return {
      success: true,
      section: { ...newCollection, id: newCollection.id },
    }; // Normalize return
  } catch (error) {
...
export async function getCuratorData(username: string) {
  try {
    ...
    if (!user) {
      try {
        ...
        const match = possibleUsers.find((u) => {
          ...
          return (
            nameSlug === targetSlug ||
            (u.username && u.username.toLowerCase() === targetSlug)
          );
        });
    ...
    const [instagramPosts, tiktokPosts] = await Promise.all([
      getInstagramPosts(user.id),
      getTiktokPosts(user.id)
    ]);
    ...
    return {
      user: {
        ...user,
        totalEarnings: user.totalEarnings?.toString() || "0", // CRITICAL: Decimal cannot be passed to RSC
