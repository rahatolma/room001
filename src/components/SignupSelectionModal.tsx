            ...
            <div className={styles.modalWrapper}>
                ...
                <div className={styles.container}>
                    ...
                    <div className={`${styles.column} ${styles.creator}`}>
                        <div className={styles.content}>
                            <h2 className={styles.title}>Creator</h2>
                            <p className={styles.description}>Harika zevklerin büyük fırsatlara dönüştüğü yer.</p>
                            <button className={styles.button} onClick={onCreatorClick}>BAŞVUR</button>
                        </div>
                    </div>
                    ...
                    <div className={`${styles.column} ${styles.brand}`}>
                        <div className={styles.content}>
                            ...
                            <button className={styles.button} onClick={onBrandClick}>BAŞVUR</button>
                        </div>
                    </div>
                </div>
