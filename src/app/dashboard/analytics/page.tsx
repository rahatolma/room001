...
const performanceData = [
    { date: '1 Şub', views: 4000, clicks: 240 },
    { date: '5 Şub', views: 3000, clicks: 139 },
    { date: '10 Şub', views: 2000, clicks: 980 },
    { date: '15 Şub', views: 2780, clicks: 390 },
    { date: '20 Şub', views: 1890, clicks: 480 },
    { date: '25 Şub', views: 2390, clicks: 380 },
    { date: '28 Şub', views: 3490, clicks: 430 },
];

const sourceData = [
    { name: 'Instagram', value: 65, color: '#E1306C' },
    { name: 'TikTok', value: 25, color: '#000000' },
    { name: 'Direct/Web', value: 10, color: '#059669' },
];
...
const topProducts = [
    ...
    { id: 4, name: "MacBook Pro M3", brand: "Apple", clicks: 154, orders: 2, conversion: "1.2%", revenue: "₺12.000" },
];

export default function AnalyticsPage() {
    return (
        <div style={{ maxWidth: 1200, paddingBottom: 100 }}>
            <h1 style={{ fontSize: '2.5rem', fontWeight: 500, marginBottom: 50, letterSpacing: -0.5 }}>Performans İstatistikleri</h1>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 20, marginBottom: 40 }}>
                <KpiCard title="Toplam Görüntülenme" value="124.5K" trend="+12%" icon={<Eye size={20} />} />
                <KpiCard title="Toplam Tıklanma" value="18.2K" trend="+24%" icon={<MousePointerClick size={20} />} />
                <KpiCard title="Dönüşüm Oranı (CTR)" value="%4.2" trend="+0.8%" icon={<ArrowUpRight size={20} />} />
                <KpiCard title="Yönlendirilen Satış" value="395" trend="+18%" icon={<ShoppingBag size={20} />} />
            </div>
