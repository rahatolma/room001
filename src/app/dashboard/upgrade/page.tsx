...
export default function UpgradePage() {
    return (
        <div style={{ maxWidth: 800 }}>
            <h1 style={{ fontSize: '2rem',  marginBottom: 20 }}>Kazanmak İçin Yükselt</h1>

            <div style={{ marginBottom: 40 }}>
                <h2 style={{ fontSize: '1.2rem',  marginBottom: 10, color: '#333' }}>İçerik Üreticisi hesabına yükseltin.</h2>
