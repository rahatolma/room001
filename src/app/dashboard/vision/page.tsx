        ...
        <div style={{ maxWidth: 1200, paddingBottom: 60 }}>
            ...
            <div style={{
                ...
                <div style={{ position: 'relative', zIndex: 2, maxWidth: 700 }}>
                    ...
                    <h1 style={{ fontSize: '3rem', fontWeight: 700, marginBottom: 20, lineHeight: 1.1 }}>
                        ...
                        <span style={{ color: '#a855f7' }}>Medya İmparatorluğun.</span>
                    </h1>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: 30 }}>
                ...
                <div style={{
                    ...
                    <div style={{ height: 200, background: '#f5f3ff', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
                        <div style={{ position: 'absolute', inset: 0, opacity: 0.1, backgroundImage: 'radial-gradient(#a855f7 1px, transparent 1px)', backgroundSize: '20px 20px' }} />
                        <div style={{
                            width: 80, height: 80, background: 'linear-gradient(135deg, #a855f7 0%, #7e22ce 100%)',
                    ...
                    <div style={{ padding: 30 }}>
                        ...
                        <Link href="/dashboard/media-kit" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, color: '#7e22ce', fontWeight: 600, textDecoration: 'none' }}>
                ...
                <div style={{
                    ...
                    <div style={{ height: 200, background: '#fff7ed', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
                        <div style={{ position: 'absolute', inset: 0, opacity: 0.1, backgroundImage: 'radial-gradient(#f97316 1px, transparent 1px)', backgroundSize: '20px 20px' }} />
                        <div style={{
                            width: 80, height: 80, background: 'linear-gradient(135deg, #f97316 0%, #c2410c 100%)',
                            borderRadius: 20, display: 'flex', alignItems: 'center', justifyContent: 'center',
                    ...
                    <div style={{ padding: 30 }}>
                        ...
                        <Link href="/dashboard/integrations" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, color: '#c2410c', fontWeight: 600, textDecoration: 'none' }}>
                ...
                <div style={{
                    ...
                    <div style={{ height: 200, background: '#fefce8', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
                        <div style={{ position: 'absolute', inset: 0, opacity: 0.1, backgroundImage: 'radial-gradient(#eab308 1px, transparent 1px)', backgroundSize: '20px 20px' }} />
                        <div style={{
                            width: 80, height: 80, background: 'linear-gradient(135deg, #eab308 0%, #ca8a04 100%)',
                            borderRadius: 20, display: 'flex', alignItems: 'center', justifyContent: 'center',
                    ...
                    <div style={{ padding: 30 }}>
                        ...
                        <Link href="/dashboard/promote" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, color: '#ca8a04', fontWeight: 600, textDecoration: 'none' }}>
                ...
                <div style={{
                    ...
                    <div style={{ height: 200, background: '#fce7f3', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
                        <div style={{ position: 'absolute', inset: 0, opacity: 0.1, backgroundImage: 'radial-gradient(#ec4899 1px, transparent 1px)', backgroundSize: '20px 20px' }} />
                        <div style={{
                            width: 80, height: 80, background: 'linear-gradient(135deg, #ec4899 0%, #be185d 100%)',
                            borderRadius: 20, display: 'flex', alignItems: 'center', justifyContent: 'center',
                    ...
                    <div style={{ padding: 30 }}>
                        ...
                        <Link href="/dashboard/brand-match" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, color: '#be185d', fontWeight: 600, textDecoration: 'none' }}>
