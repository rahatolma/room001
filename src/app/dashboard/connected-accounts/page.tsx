...
export default function ConnectedAccountsPage() {
    return (
        <div style={{ paddingBottom: 100, fontFamily: 'sans-serif' }}>
            ...
            <h1 style={{ fontSize: '2.5rem', fontFamily: 'serif', fontWeight: 500, marginBottom: 50 }}>Bağlı Hesaplar</h1>

            <div style={{ marginBottom: 40 }}>
                <h2 style={{ fontSize: '1.1rem', fontFamily: 'serif', marginBottom: 15 }}>Ödeme Hesabı Bağla</h2>
